<template>
    <footer>
        <div class="back">
            <span class="marquee" >本質を汲み取り、対話すること。視覚領域へと正しく落とし込むこと。知って、感じて、喜んで貰うこと。視覚表現はあくまでも、ブランド・プロダクトに寄り添うものであり、本質を汲み取り、対話し、その延長線上で行われるべきであると考えます。そして落とし込む。この落とし込みのプロセスは多々、”創造する”や”変換する”といった言葉で説明されますが、”落とし込む”が最適のように感じます。汲み取り、対話して得たものを抽出して、そのままの感覚を視覚領域に広げていく。そしてそれを感じとって、喜んでもらう、これが視覚表現を通して成したいことです。
            </span>
        </div>
...
footer div.back span {
    animation: marquee 150s linear infinite;
    color: var(--backgroundColor);}


footer h1 {margin-bottom: calc(var(--pX) * 6.5);}
footer .Logo {width: 12.5rem;}
footer .Logo , footer .Logo g {fill: white;}

footer .wrapper {margin-bottom: calc(var(--pX) * 7.5);}
footer .container {margin-bottom: calc(var(--pX) * 10);}
footer .container h3 {margin-bottom: calc(var(--pX) * 4);}
footer .container h3 a {text-decoration: underline;}
